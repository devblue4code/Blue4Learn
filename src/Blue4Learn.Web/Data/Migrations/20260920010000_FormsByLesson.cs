...
namespace Blue4Learn.Web.Data.Migrations
{
    ...
    [Migration("20260920010000_FormsByLesson")]
    public class FormsByLesson : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Recreate CourseForms scoped to Lesson (feature was just introduced; drop+recreate is safe).
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseForms_Lessons_LessonId",
                        column: x => x.LessonId,
